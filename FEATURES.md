...
## Search & Retrieval
- 🔌 **Semantic / vector search** — `GET /api/v1/captures/search?q=…` over pgvector embeddings (cosine); provider-agnostic (OpenAI-compatible). Disabled on the public demo (503); demonstrated via integration tests.
